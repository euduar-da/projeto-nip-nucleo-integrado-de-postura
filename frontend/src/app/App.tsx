...
async function chamarLogoutNoBackend() {
      ...
      >
        ...
        <div className="p-3 border-t border-sidebar-border">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-red-500 hover:bg-red-500/10 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            <LogOut size={17} />
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {user.tipo === "colaborador" && user.perfil
                  ? `${
                      user.perfil.charAt(0).toUpperCase() +
                      user.perfil.slice(1)
                    }`
